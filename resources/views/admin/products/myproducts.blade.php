...
<div class="card card-success">
    <div class="panel panel-default-success">
        <div class="card-header with-border ">
            ...
            Productos de: 
            <!--a href="{*{ route('commerce_show', $commerce->commerce_slug) }}" >
                {*{$commerce->nombre}}    
            <img src="{*{$commerce->file}}" class="img-circle elevation-2" height="70px" box-shadow="2px" 
            alt="User Image">
            </h3></a-->
        </div>
        <div class="card-header with-border ">
            <h3 class="card-title">Articulos</h3> @section('titulo') {{$commerce->nombre}} @endsection
        </div>
