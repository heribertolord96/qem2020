...
<head>
  ...
  <title>Storeblog | @yield('titulo')  </title>
  ...
  <link rel="stylesheet" href="{{ asset('css/lte-template.css') }}">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018-{{ date('Y') }}  <a href="http://quickemart.store">QEM Abtract</a>.</strong> All rights
    reserved.
